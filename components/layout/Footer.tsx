  ...
  return (
    <footer className="relative bg-white/80 backdrop-blur-xl border-t border-black/5 pt-24 pb-12 px-8 overflow-hidden">
      ...
      <div className="container mx-auto relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-16 mb-12 md:mb-20">
          {/* Brand Column */}
          <div className="space-y-6">
            <h3 className="text-2xl font-extrabold tracking-tighter text-secondary">
              Meech.
            </h3>
            <p className="text-text-secondary leading-relaxed text-sm">
              Zimbabwean streetwear. Authentic designs. Crafted for the urban
              student.
            </p>
          </div>
          ...
          {/* Links */}
          <div className="space-y-6">
            <h4 className="text-[10px] font-bold tracking-widest text-text-secondary">
              Shop
            </h4>
        ...
        <div className="border-t border-border pt-8 flex flex-col md:flex-row items-center justify-between text-[11px] font-bold text-text-secondary tracking-tight">
          <div className="space-y-1 text-center md:text-left">
            ...
            <p className="font-inter tracking-widest text-[9px]">
              powered by{" "}
              <span className="text-secondary font-black font-inter">
                STATIQUEX
              </span>
            </p>
          </div>
