    ...
    <div className="bg-white min-h-screen pt-24 pb-24 md:pt-32 md:pb-32 px-6 overflow-hidden">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-start">
          {/* Header Section */}
          <div className="lg:col-span-12 mb-12 md:mb-16">
            <motion.div
          ...
          {/* Narrative Section */}
          <div className="lg:col-span-7 pt-8 lg:pt-16 space-y-10 md:space-y-16">
            <motion.div
            ...
            >
              <div className="space-y-6 text-xl md:text-2xl text-primary font-bold leading-[1.3] tracking-tight">
                <p>
                  Founded in Chinhoyi by Meech,{" "}
                  <span className="text-secondary px-2 bg-secondary/5 rounded-pill">
                    The Meech Experience
                  </span>{" "}
                  is more than just a clothing label. It is a reflection of the
                  urban spirit that thrives in Zimbabwean universities.
                </p>
                <p className="text-text-secondary">
                  Local students deserve high-quality, authentic streetwear that
                  actually fit their lifestyle. Every piece is curated with a
                  focus on fit, fabric, and the "drops" that keep the streets
                  talking.
                </p>
                <p className="opacity-40">
                  Our mission is simple: to bring authentic urban gear to the
                  hands of every student who dares to express themselves.
                </p>
              </div>

              <div className="pt-10 md:pt-16 grid grid-cols-2 gap-6 md:gap-10 border-t border-black/5">
                <div className="space-y-4">
                  <div className="flex items-center gap-3 text-secondary">
                    <p className="text-[10px] text-text-secondary font-bold tracking-widest">
                      Roots & HQ
                    </p>
                  </div>
        ...
        {/* Credit Section */}
        <div className="mt-24 md:mt-32 pt-12 md:pt-20 border-t border-black/5 flex flex-col items-center pb-12 md:pb-20">
          <motion.div
            initial={{ opacity: 0 }}
