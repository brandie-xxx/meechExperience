...
const Home: React.FC = () => {
  ...
  return (
    <div className="pb-24">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          >
            ...
            >
              <Link
                to="/shop"
                className="group bg-white text-black px-12 py-4 rounded-pill font-black text-sm hover:bg-secondary hover:text-white transition-all scale-hover shadow-2xl flex items-center space-x-3"
              >
      ...
      <section className="container mx-auto px-6 py-12 md:py-20 max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 h-auto md:h-[700px]">
          <Link
            ...
            className="md:col-span-12 lg:col-span-7 relative rounded-[40px] overflow-hidden group shadow-apple-card border border-white/20"
          >
            <img
              src={SITE_ASSETS.categories.apparel}
              className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-1000"
              alt="Clothes"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent" />
            <div className="absolute bottom-12 left-12 text-white space-y-3">
              <h3 className="text-5xl md:text-6xl font-bold tracking-tighter leading-none">
                Essential <br /> Apparel
              </h3>
              <p className="text-white/60 font-medium text-sm max-w-sm">
                Crafted for the streets. Made for the people.
              </p>
          ...
          <div className="md:col-span-12 lg:col-span-5 grid grid-rows-2 gap-6">
            <Link
              ...
              className="relative rounded-[40px] overflow-hidden group shadow-apple-card border border-white/20"
            >
              <img
                src={SITE_ASSETS.categories.footwear}
            ...
            >
              <img
                src={SITE_ASSETS.categories.accessories}
                className="absolute inset-0 w-full h-full object-cover group-hover:scale-110 transition-transform duration-700"
                alt="Caps"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent" />
      ...
      {/* Bestsellers Grid */}
      <section className="container mx-auto px-6 py-12 md:py-20 bg-white/50 backdrop-blur-2xl rounded-[32px] md:rounded-[64px] border border-white/20 shadow-apple-hover max-w-6xl">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6 px-4">
          <motion.div
            ...
            className="space-y-3"
          >
            <span className="text-secondary font-bold text-[11px] tracking-widest uppercase">
              Our
            </span>
          ...
          <Link
            to="/shop"
            className="text-[11px] font-bold tracking-widest text-primary border-b-2 border-secondary pb-1 hover:text-secondary transition-colors"
          >
            Full Collection
          </Link>
        </div>
      ...
      <section className="container mx-auto px-6 py-16 md:py-24">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
          {REVIEWS.map((review) => (
            <div
              key={review.id}
              className="bg-white p-10 rounded-[32px] border border-border shadow-apple-card space-y-6"
            >
      ...
      <section className="container mx-auto px-6 mb-16 md:mb-24">
        <div className="bg-primary px-6 md:px-32 py-16 md:py-24 rounded-[32px] md:rounded-[48px] text-white overflow-hidden relative">
          ...
          <div className="max-w-2xl relative z-10 space-y-8">
            ...
            <p className="text-xl text-white/70 font-medium leading-relaxed">
              Sign up for notifications on new releases, restocks, and exclusive
              in-person pop-ups at Chinhoyi campus.
            </p>
            ...
            <div className="flex items-center space-x-3 text-sm font-medium opacity-60">
              <input
                type="checkbox"
                id="whatsapp-opt"
                className="rounded-sm bg-white/10 border-white/20"
              />
              <label htmlFor="whatsapp-opt">
                Also send me alerts via WhatsApp
              </label>
            </div>
          </div>
        </div>
