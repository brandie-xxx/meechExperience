...
const ProductDetail: React.FC = () => {
  ...
  return (
    <div className="bg-white min-h-screen pt-24 pb-24 md:pt-32 md:pb-32 overflow-hidden">
      <div className="container mx-auto px-6">
        <Link
          to="/shop"
          className="inline-flex items-center space-x-3 text-text-secondary hover:text-primary transition-all mb-8 md:mb-12 font-bold text-xs group"
        >
          <ArrowLeft className="w-4 h-4 group-hover:-translate-x-1 transition-transform" />
          <span>Back to catalogue</span>
        </Link>

        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-start mb-16 md:mb-24">
          {/* Immersive Gallery */}
          ...
          <div className="lg:col-span-5 sticky top-24 md:top-32 space-y-12 md:space-y-20">
            <div className="space-y-8">
              ...
              <div className="flex items-center gap-8">
                ...
                <div className="space-y-1">
                  <p className="text-[11px] font-bold text-text-secondary opacity-40">
                    ZWG equivalent
                  </p>
                  <p className="text-lg font-bold text-primary">
                    {product.priceZwg} ZWG
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-10 md:space-y-16">
              ...
              <div className="pt-10 md:pt-20 space-y-6 border-t border-black/5">
                <div className="flex items-start gap-6 opacity-40">
                  <Info className="w-6 h-6 text-primary shrink-0" />
                  <p className="text-xs font-semibold leading-relaxed">
                    This drop is part of our{" "}
                    <strong className="font-black underline text-secondary decoration-2 underline-offset-4">
                      Chinhoyi Urban Collection
                    </strong>
                    . Hand-finished with premium Zimbabwe-grown cotton. Built to
                    last.
                  </p>
                </div>
              </div>
        ...
        {relatedProducts.length > 0 && (
          <div className="pt-16 md:pt-24 border-t border-black/5">
            <div className="flex items-end justify-between mb-20">
              ...
              <Link
                to="/shop"
                className="text-xs font-bold text-primary border-b-2 border-secondary pb-1 hover:text-secondary transition-colors"
              >
                View full drop
              </Link>
            </div>
