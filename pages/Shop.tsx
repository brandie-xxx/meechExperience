      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-10">
          <motion.div
            ...
            className="space-y-4"
          >
            <h1 className="text-6xl md:text-[8vw] font-extrabold tracking-[-0.06em] leading-[0.8] text-primary">
              Curated <br />
        ...
        {/* Global Filter Bar */}
        <div className="sticky top-24 z-30 mb-20 px-2 lg:px-0">
          <div className="bg-white/90 backdrop-blur-2xl px-6 py-6 lg:py-3 lg:px-8 rounded-[32px] lg:rounded-pill border border-black/5 shadow-[0_20px_50px_rgba(0,0,0,0.08)] flex flex-col lg:flex-row items-center gap-4 lg:gap-6">
        ...
        {filteredProducts.length === 0 && (
          <div className="text-center py-60 space-y-12">
            <h3 className="text-4xl font-extrabold tracking-tighter opacity-20">Nothing matches the vibe.</h3>
            <button 
